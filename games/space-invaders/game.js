export function init(container, args){
  ...
  function createShip(level, index=0, total=1){
    ...
    return {x:dir===1?-120-index*150:W+120+index*150,y:yBase,w:cfg.w,h:cfg.h,hp:hpBase,maxHp:hpBase,dir,speed:cfg.speed+(level-1)*2,hitFlash:0,cfg,ghostTimer:0,zigTimer:0,teleportTimer:0,originalY:yBase};
  }
