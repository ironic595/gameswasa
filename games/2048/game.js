...
.w-win-btn{width:100%;padding:12px;border-radius:12px;font-weight:800;font-size:11px;text-transform:uppercase;cursor:pointer;border:2px solid #5c4033;margin-top:8px}.w-win-btn.x2{background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#000}.w-win-btn.secondary{background:#3e2723;color:#f5deb3}.w-win-btn.ghost{background:#f5deb3;color:#3e2723}
  </style><div class="w2048" id="wRoot"><div class="w-top"><div style="font-weight:800;font-size:12px">🪵 2048 MADERA • 0,001 cada 20 + X2 AD</div><div style="display:flex;gap:5px"><button class="w-pill yellow" id="wStats">BEST 0</button><button class="w-pill" id="wNew">↻ NUEVO</button></div></div><div class="w-body"><div class="w-left"><div class="w-board-wrap"><div class="w-grid" id="wGrid"></div><div class="w-tiles" id="wTiles"></div></div><div style="background:rgba(245,222,179,.7);border:1px solid #5c4033;border-radius:12px;padding:10px"><div style="display:flex;justify-content:space-between;font-size:10px;font-weight:800;margin-bottom:6px"><span>PROGRESO AD (20 merges = 0,001 + X2)</span><span id="wProgText">0/20</span></div><div class="w-progress"><div class="w-progress-bar" id="wProgBar"></div></div></div></div><div class="w-right"><div class="w-stats"><div class="w-stat"><b id="wScore">0</b><span>SCORE</span></div><div class="w-stat"><b id="wBest">0</b><span>BEST</span></div><div class="w-stat"><b id="wReward">+0.000000</b><span>WASA TOTAL</span></div><div class="w-stat"><b id="wCount">0</b><span>MERGES</span></div></div><div class="w-controls"><button class="w-btn" id="wUp">↑</button><button class="w-btn" id="wUp2">↑</button><button class="w-btn" id="wDown">↓</button><button class="w-btn" id="wLeft">←</button><button class="w-btn" id="wReset">RESET</button><button class="w-btn" id="wRight">→</button></div><div style="font-size:11px;line-height:1.5;color:#3e2723;background:rgba(245,222,179,.6);border:1px solid rgba(92,64,51,.2);border-radius:12px;padding:12px"><b>Nueva economía:</b> Cada <b>20 combinaciones</b> = <b>0,001 WASA</b>. Podés ver un anuncio para <b>duplicar a 0,002 WASA</b> (igual que banatron).</div></div></div><div id="wUI"></div></div>`;
